...
<?php include __DIR__ . './_nav.php' ?>
    ...
    <script>
        ...
        function switch_update_form(e) {
            ...
            console.log(ori_obj[id]);
            let tr_str = `
                        <td>${ori_obj['id']}</td>
                        <td><input type="text" value="${ori_obj['name']}"></td>
                        <td><input type="text" value="${ori_obj[condi]}"></td>
                        <td><input type="text" value="${ori_obj['dis_num']}"></td>
                        <td><input type="text" value="${ori_obj['dis_type']}"></td>
                        <td><input type="text" value="${ori_obj['start']}"></td>
                        <td><input type="text" value="${ori_obj['end']}"></td>`
            tr.innerHTML = tr_str;
